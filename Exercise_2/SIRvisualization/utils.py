...
def create_folder_data_scatter(folder):
    ...
    ID_SUSCEPTIBLE = 1
    ID_INFECTED = 0
    # ID_REMOVED = 2 currently not used
    ID_RECOVERED = 2

    group_counts = file_df_to_count_df(
        data, ID_INFECTED=ID_INFECTED, ID_SUSCEPTIBLE=ID_SUSCEPTIBLE, ID_RECOVERED=ID_RECOVERED)
    # group_counts.plot()
